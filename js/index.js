...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _routing = __webpack_require__(328);
	
	__webpack_require__(337);
	__webpack_require__(341);
	
	_routing.APP_ROUTER.init();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _listListComponent = __webpack_require__(330);
	
	var _userUserComponent = __webpack_require__(333);
	
	var _listGuard = __webpack_require__(334);
	
	var _init = __webpack_require__(335);
	
	var APP_ROUTER = new _router.Router(
	// {
	//     id: "Assessment",
	...
	_init.app.rootNode, [{
	    ...
	    id: "List",
	    path: "/list",
	    component: _listListComponent.ListComponent
	}, {
	    id: "User",
	    path: "/user/:id",
	    component: _userUserComponent.UserComponent,
	    canActivate: _listGuard.listGuard
	}], _init.app);
...
/***/ (function(module, exports) {
	...
	*/
	...
	var Router = (function () {
	    function Router(outlet, map, app) {
	...
	var isParam = function isParam(level) {
	    return level[0] === ":";
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _componentJs = __webpack_require__(331);
	
	var _routingJs = __webpack_require__(328);
	
	var _storeStoreJs = __webpack_require__(332);
	
	var ListComponent = (function (_Component) {
	    _inherits(ListComponent, _Component);
	
	    function ListComponent(conf) {
	        _classCallCheck(this, ListComponent);
	
	        _get(Object.getPrototypeOf(ListComponent.prototype), 'constructor', this).call(this, conf);
	    }
...
/***/ (function(module, exports) {
	...
	var Component = (function () {
	    ...
	    _createClass(Component, [{
	        ...
	        key: "extractMatches",
	        value: function extractMatches() {}
	    }, {
	        key: "onEvent",
	        value: function onEvent(eventName, selector, callback) {
	            this._app.registerEvent(eventName, this.id, selector, callback);
	        }
	    }, {
	        key: "init",
	        value: function init(baseNode) {
	            this.beforeInit();
	        ...
	        key: "destroy",
	        value: function destroy(baseNode) {
	            baseNode.innerHTML = "";
...
/***/ (function(module, exports) {
	...
	var users = [{
	    ...
	    "gender": "male",
	    "company": "ZENSUS",
	    "email": "navarromorales@zensus.com",
	    "phone": "+1 (888) 473-2734",
	    "about": "Consectetur ut id incididunt do exercitation. Adipisicing est velit ullamco fugiat. Aliquip ipsum aute id aute ex reprehenderit commodo sint qui fugiat aute. Ut sunt eu quis anim irure minim ex commodo.\r\n",
	    "registered": "2015-02-15T03:48:01 -02:00",
	    "tags": ["ullamco", "pariatur", "deserunt", "magna", "eiusmod", "qui", "voluptate"],
	    "friends": [{
	        "id": 0,
	        "name": "Nola Huff"
	    }, {
	        "id": 1,
	        "name": "Cervantes Hayden"
	    }, {
	        "id": 2,
	        "name": "Cristina Melton"
	    }],
	    "greeting": "Hello, Navarro! You have 2 unread messages.",
	    "favoriteFruit": "banana"
	}, {
	    "index": 2,
	    "guid": "7c186fcd-9275-429a-bc9a-145244cddc01",
	    "isActive": true,
	    "balance": "$2,680.59",
	    "picture": "https://placekitten.com/280/280",
	    "age": 4,
	    ...
	    "gender": "male",
	    "company": "ZENTILITY",
	    "email": "lawsonmelton@zentility.com",
	    "phone": "+1 (822) 523-2284",
	    "about": "Amet ex exercitation sit ad veniam enim Lorem ea tempor incididunt. Adipisicing est et fugiat velit occaecat eiusmod quis ex. Pariatur aliqua magna ex quis duis voluptate aliquip consequat minim sunt deserunt tempor. Culpa sunt eu veniam aliquip do. Aliqua excepteur aute id voluptate quis adipisicing est. Consequat aliquip commodo incididunt cupidatat laboris anim fugiat qui.\r\n",
	    "registered": "2014-10-06T12:49:33 -03:00",
	    "tags": ["commodo", "in", "laboris", "duis", "voluptate", "dolore", "consequat"],
	    "friends": [{
	        "id": 0,
	        "name": "Ortega Oconnor"
	    }, {
	    ...
	    "greeting": "Hello, Lawson! You have 4 unread messages.",
	    "favoriteFruit": "apple"
	}, {
	    "index": 3,
	    "guid": "ca506415-3d52-4d03-b9e9-acd46b8d7280",
	    "isActive": false,
	    "balance": "$2,226.46",
	    "picture": "https://placekitten.com/280/280",
	    "age": 2,
	    ...
	    "gender": "male",
	    "company": "PETICULAR",
	    "email": "paynewalter@peticular.com",
	    "phone": "+1 (859) 443-2238",
	    "about": "Dolor in cupidatat ad enim ea dolor occaecat. Velit do nisi ut est elit magna sint magna consectetur dolor mollit dolore occaecat. Cupidatat in dolore esse Lorem ullamco anim laborum qui laborum commodo adipisicing in. Exercitation anim id magna dolore anim dolor.\r\n",
	    "registered": "2016-08-05T01:07:33 -03:00",
	    "tags": ["aliqua", "consequat", "aliquip", "in", "magna", "excepteur", "veniam"],
	    "friends": [{
	        "id": 0,
	        "name": "Cohen Mathews"
	    }, {
	    ...
	    "greeting": "Hello, Payne! You have 3 unread messages.",
	    "favoriteFruit": "banana"
	}, {
	    "index": 4,
	    ...
	    "tags": ["proident", "incididunt", "do", "commodo", "sunt", "deserunt", "qui"],
	    "friends": [{
	        "id": 0,
	        "name": "Clemons Joyce"
	    }, {
	    ...
	    "index": 5,
	    "guid": "d735dc79-5022-47ca-9004-c9691829b8be",
	    "isActive": false,
	    "balance": "$2,632.67",
	    "picture": "https://placekitten.com/280/280",
	    "age": 12,
	    ...
	    "gender": "female",
	    "company": "GINKLE",
	    "email": "traciromero@ginkle.com",
	    "phone": "+1 (924) 434-3302",
	    "about": "Esse cupidatat consectetur aliqua ex duis mollit esse ea. Qui aliqua irure anim sint. Dolore do labore excepteur proident proident.\r\n",
	    "registered": "2015-05-24T03:36:46 -03:00",
	    "tags": ["dolor", "ut", "commodo", "laboris", "officia", "anim", "eu"],
	    "friends": [{
	        "id": 0,
	        "name": "Barr Beard"
	    }, {
	    ...
	    "greeting": "Hello, Traci! You have 5 unread messages.",
	    "favoriteFruit": "apple"
	}, {
	    "index": 6,
	    "guid": "68d54469-cbd9-4aac-89b0-8d8e71e75997",
	    "isActive": false,
	    "balance": "$3,506.86",
	    "picture": "https://placekitten.com/280/280",
	    "age": 9,
	    ...
	    "gender": "male",
	    "company": "PIGZART",
	    "email": "hopkinsbarr@pigzart.com",
	    "phone": "+1 (987) 578-3383",
	    "about": "Nostrud cillum velit adipisicing consectetur nostrud. Esse tempor Lorem eu magna et ad minim Lorem Lorem nulla ut fugiat elit nisi. Voluptate cillum cupidatat culpa in nisi nisi. In nulla nisi nisi enim ad esse ad minim nulla. Veniam culpa sunt duis Lorem velit cupidatat eu consequat duis qui sunt.\r\n",
	    "registered": "2017-11-03T09:36:58 -02:00",
	    "tags": ["labore", "culpa", "ut", "duis", "est", "tempor", "sit"],
	    "friends": [{
	        "id": 0,
	        ...
	        "id": 2,
	        "name": "Loretta Schneider"
	    }],
	    "greeting": "Hello, Hopkins! You have 5 unread messages.",
	    "favoriteFruit": "strawberry"
	}, {
	    "index": 7,
	    "guid": "0f53d1d4-549f-48ea-a4d5-78c08db68584",
	    "isActive": false,
	    "balance": "$1,014.50",
	    "picture": "https://placekitten.com/280/280",
	    "age": 7,
	    ...
	    "gender": "female",
	    "company": "EYEWAX",
	    "email": "shirleyschneider@eyewax.com",
	    "phone": "+1 (952) 492-2423",
	    "about": "Dolore mollit pariatur in id aliquip. Cupidatat velit magna nostrud ut Lorem dolor aliqua sint nisi laboris aliquip culpa irure. Irure non voluptate eiusmod reprehenderit. Reprehenderit minim laborum incididunt ut commodo laborum consequat. Duis cupidatat incididunt occaecat sunt laborum eiusmod reprehenderit sunt in proident incididunt elit. Do veniam ad dolore culpa dolore laborum dolore irure ea.\r\n",
	    "registered": "2017-05-22T03:07:46 -03:00",
	    "tags": ["amet", "est", "voluptate", "quis", "ullamco", "enim", "in"],
	    "friends": [{
	        "id": 0,
	        "name": "Lina Waller"
	    }, {
	    ...
	    "greeting": "Hello, Shirley! You have 3 unread messages.",
	    "favoriteFruit": "apple"
	}];
	exports.users = users;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var UserComponent = (function (_Component) {
	    ...
	    function UserComponent(conf) {
	        _classCallCheck(this, UserComponent);
	
	        _get(Object.getPrototypeOf(UserComponent.prototype), 'constructor', this).call(this, conf);
	    }
	    ...
	    _createClass(UserComponent, [{
	        ...
	        value: function onInit() {
	            ...
	            var id = _routingJs.APP_ROUTER.currentRoute.params.id;
	            var usr = _storeStoreJs.users.find(function (u) {
	                return u.index == +id;
	            });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var listGuard = function listGuard(params) {
	    return _storeStoreJs.users && _storeStoreJs.users.length && !isNaN(+params.id - 1) && _storeStoreJs.users.find(function (u) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var app = new _app.App(document.querySelector('#router-outlet'));
	exports.app = app;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var App = (function () {
	    ...
	    _createClass(App, [{
	        key: 'registerEvent',
	        value: function registerEvent(eventName, componentId, elementSelector, callback) {
	            var _this = this;
	        ...
	        key: '_delegete',
	        value: function _delegete(event) {
	            var target = event.target;
	            var id = _routing.APP_ROUTER.currentRoute.id;
	        ...
	        key: 'clearComponentEvents',
	        value: function clearComponentEvents(id) {
	            if (!id || !this._eventMap[event.type] || !this._eventMap[event.type][id]) return;
